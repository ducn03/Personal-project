    ...
    <aside id="fh5co-hero" class="js-fullheight">
        <div class="flexslider js-fullheight">
            <ul class="slides">
                ...
                <li style="background-image: url({{ asset('asset/user/img/img_bg_1.jpg') }});">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
                            <div class="slider-text-inner">
                                <div class="desc">
                                    ...
                                    <p><a href="{{ url('productDetail/7') }}"
                                            class="btn btn-primary btn-outline btn-lg">View Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 text-center animate-box">
                    <div class="product">
                        <div class="product-grid"
                            ...
                            <div class="inner">
                                <p>
                                    <a href="{{ url('/add-to-cart/' . $p->id) }}" class="icon"><i
                                            class="icon-shopping-cart"></i></a>
                                    <a href="{{ url('productDetail/' . $p->id) }}" class="icon"><i
                                            class="icon-eye"></i></a>
                                </p>
                            </div>
                        </div>
