        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center animate-box" style="padding: 0 5% 0 5%">
                    <form action="{{ url('/srAllProductName') }}">
                        <div class="row">
                ...
                {{-- SELECT --}}
                <div class="col-md-6 text-center animate-box" style="padding: 0 5% 0 5%">
                    <form action="{{ url('/srAllProductFilter') }}">
                        <div class="row">
                            <div class="col-md-10 text-center animate-box">
            ...
            {{-- SEARCH PRICE --}}
            <form action="{{ url('/srAllProductPrice') }}">
                <div class="row" style="padding: 0 20% 0 20%">
                    <div class="col-md-6 text-center animate-box">
                        FROM
                        <input name="price1" class="form-control" type="number" min="1"
                            placeholder="Enter a price">
                    </div>
                    <div class="col-md-6 text-center animate-box">
                        TO
                        <input name="price2" class="form-control" type="number" max="10000"
                            placeholder="Enter a price">
                    </div>
                </div> <br>
                <div class="row">
