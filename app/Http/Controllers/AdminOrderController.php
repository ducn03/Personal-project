...
class AdminOrderController extends Controller
{
    public function index(){
        ...
        ->orderByRaw('id DESC')
        ->get();
        $ds2 = DB::table('order_item')->get();

        return view('admin.order.viewOrder')->with(['order' => $ds, 'orderItem' => $ds2]);
    }
    ...
    public function updateOrder($id)
    {
        ...
        $s = DB::table('account')
            ->where('role', intval('2'))
            ->get();
        return view('admin.order.updateOrder')->with(['o' => $o, 'order_item' => $oi, 'staff' => $s]);
    }
    ...
    public function deleteOrder($id)
    {
        ...
        $oi = DB::table('order_item')
            ...
            ->join('product', 'order_item.product_id', '=', 'product.id')
            ->get();
        return view('admin.order.deleteOrder')->with(['o' => $o, 'order_item' => $oi]);
    }
